<?php
// Handle Chinese routing
$request = trim(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), '/');

// If it's a Chinese page, redirect to the Chinese version
if ($request === 'cn' || $request === 'cn/' || strpos($request, 'cn/') === 0) {
    // Remove 'cn/' from the request to get the actual page
    $cn_request = str_replace('cn/', '', $request);
    $cn_request = str_replace('cn', '', $cn_request);
    $cn_request = ltrim($cn_request, '/');
    
    // If it's just 'cn' or 'cn/', show the home page
    if (empty($cn_request)) {
        include $_SERVER['DOCUMENT_ROOT'] . '/cn/index.php';
        exit;
    }
    
    // Check if the Chinese page exists
    $cn_file = $_SERVER['DOCUMENT_ROOT'] . '/cn/' . $cn_request . '/index.php';
    if (file_exists($cn_file)) {
        include $cn_file;
        exit;
    }
    
    // If no specific page found, show the home page
    include $_SERVER['DOCUMENT_ROOT'] . '/cn/index.php';
    exit;
}
              ...
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/local-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/local_kol.webp">
                    <div class="overlay1">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-6">
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/chinese-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/china_kol.webp">
                    <div class="overlay1">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-6">
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/vietnam-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/vn_kol.webp">
                    <div class="overlay1">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-6">
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/japan-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/jp_kol.webp">
                    <div class="overlay1">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-6">
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/korea-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/kr_kol.webp">
                    <div class="overlay1">
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-6">
              <article class="card-standard">
                <a title="superbpartygirl" href="<?= localizedPath('/models/europe-party-girl/') ?>" class="productCard text-center">
                  <div class="productCard-mainPic">
                    <img alt="superbpartygirl" src="/wp-content/uploads/index/eu_kol.webp">
                    <div class="overlay1">
...
<!-- here we have to merge the  models index page -->
...
<script src="/assets/js/model_filter.js"></script>
      ...
      <div class="feature-article">
        ...
        <section class="feature-card">
          ...
          <p><?= $texts['home']['Safe party escortDesc'] ?></p>
        </section>
        ...
        <div class="grid-3">
          ...
          <section class="feature-card">
            ...
            <p>E<?= $texts['home']['yourDesiresDesc'] ?></p>
          </section>
          <section class="feature-card">
        ...
        <section class="feature-card">
          ...
          <div class="cta-buttons">
            <a href="<?= env('TELEGRAM_CHANNEL') ?>" class="btn"><?= $texts['home']['readyForAmazing'] ?></a>
            <a href="<?= env('TELEGRAM_LINK') ?>" class="btn"><?= $texts['home']['contactUs'] ?></a>
          </div>
