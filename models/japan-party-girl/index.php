...
<!-- content -->
<div class="banner-section japan-models">
  <img class="banner-img-mobile" src="/wp-content/uploads/models/background/japan-models-bg.webp" alt="Japan Party Girl">
  <div class="banner-overlay">
    <h1><?= $texts['japanModel']['modelsTitle'] ?></h1>
...
<main>
    ...
    <div class="title">
      <h2><?= $texts['japanModel']['modelsSubTitle'] ?>
    ...
    <div class="cta">
      <a href="<?= env('TELEGRAM_LINK') ?>?text=<?= $texts['japanModel']['japanFullListMsg'] ?>"><?= $texts['models']['contactFullList'] ?></a>
    </div>
  </div>
</main>
