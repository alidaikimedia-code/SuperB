...
<!-- content -->
<div class="banner-section korea-models">
  <img class="banner-img-mobile" src="/wp-content/uploads/models/background/korea-models-bg.webp" alt="Korea Party Girl">
  <div class="banner-overlay">
    <h1><?= $texts['koreaModel']['modelsTitle'] ?></h1>
...
<main>
  <div class="contentBox">
    <div class="title">
      <h3><?= $texts['koreaModel']['modelsSubTitle'] ?>
    ...
    <div class="cta">
      <a href="<?= env('TELEGRAM_LINK') ?>?text=<?= $texts['koreaModel']['koreaFullListMsg'] ?>"><?= $texts['models']['contactFullList'] ?></a>
    </div>
  </div>
</main>
