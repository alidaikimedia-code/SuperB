...
<main>
  <div class="about-cards">
    ...
    <div class="about-card">
      ...
      <a href="<?= env('TELEGRAM_LINK') ?>" class="about-btn"><?= $texts['about']['booksuperbPartyGirl'] ?></a>
    </div>
    ...
    <div class="about-cta">
      ...
      <a href="<?= env('TELEGRAM_LINK') ?>" class="about-btn book-now-btn"><?= $texts['common']['book_now'] ?></a>
    </div>
  </div>
</main>
