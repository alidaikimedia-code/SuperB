    ...
    <section class="hotels-section">
        <div class="container">
            ...
            <div class="hotels-grid">
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>W吉隆坡酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡瑞吉酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡丽思卡尔顿酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡JW万豪酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡艾美酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>八打灵再也艾美酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡喜来登帝国酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>八打灵再也喜来登酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡唐人街福朋喜来登酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>蒲种福朋喜来登酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡威斯汀酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡万豪AC酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡Element酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡条纹酒店，傲途格精选</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡雄伟酒店，傲途格精选</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡万丽酒店及会议中心</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>吉隆坡南万怡酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>布城Moxy酒店</span></div>
                <div class="hotel-card"><i class="fa-solid fa-location-dot"></i><span>布城万豪酒店</span></div>
            </div>
